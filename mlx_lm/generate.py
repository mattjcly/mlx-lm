...
def generate_step(
    ...
    *,
    ...
    Args:
       ...
       input_embeddings (mx.array, optional): Input embeddings to use for the prompt.
           Will be used in place of the prompt if provided. Default: ``None``.
    ...
    def _step(token_ids=None, embeddings=None):
        ...
        with mx.stream(generation_stream):
            if embeddings is not None:
                logits = model(None, cache=prompt_cache, input_embeddings=embeddings)
